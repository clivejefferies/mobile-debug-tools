# RFC 010.1 — Recovery Contract Types & Runtime Wiring Spec

## 1. Purpose

This document defines the typed runtime contract required to implement RFC 010 safely and consistently across:

- src/server
- src/interact
- shared action/result boundaries

It removes ambiguity from RFC 010 by formalising:
- enums
- state schemas
- execution payloads
...
This spec defines the typed contract required for implementing RFC 010 across server and interact layers.
